...
const file_auth_v1_sso_proto_rawDesc = "" +
	"\n" +
	"\x11auth/v1/sso.proto\x12\aauth.v1\"C\n" +
	...
	"\aIsAdmin\x12\x17.auth.v1.IsAdminRequest\x1a\x18.auth.v1.IsAdminResponseB\x94\x01\n" +
	"\vcom.auth.v1B\bSsoProtoP\x01Z>github.com/HollyEllmo/my_proto_repo/gen/go/auth/v1;pb_auth_sso\xa2\x02\x03AXX\xaa\x02\aAuth.V1\xca\x02\aAuth\\V1\xe2\x02\x13Auth\\V1\\GPBMetadata\xea\x02\bAuth::V1b\x06proto3"
...
var file_auth_v1_sso_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
